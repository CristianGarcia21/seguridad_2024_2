...
public class SessionsController {
    ...
    @GetMapping
    public List<Session> find() {return  this.theSessionRepository.findAll();}
    ...
    public Session update(@PathVariable String id, @RequestBody Session newSession){
        ...
        if(actualSession != null) {
            ...
            actualSession.setUsado(newSession.getUsado());
            actualSession.setFallido(newSession.getFallido());
            actualSession.setToken(newSession.getToken());
            actualSession.setExpiration(newSession.getExpiration());
            actualSession.setEndAt(newSession.getEndAt());
            actualSession.setStartAt(newSession.getStartAt());
